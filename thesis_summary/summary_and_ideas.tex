...
Modeling the user's constraints in a \emph{variational autoencoder} framework is a typical problem we are now starting to work on. \cite{bengio2013representation}, \citep{bengio2013representation}
