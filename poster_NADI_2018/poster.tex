...
\begin{multicols}{2}
    ...
    \begin{tabular}{c}
        ...
        \includegraphics[height=15em]{poster_NADI_2018/images/app_guis_no_annotations.pdf}
    \end{tabular}
    \end{center}
    \section*{\large{What are translated to the algorithm (in low dim.)}}
    \begin{center}
    \begin{tabular}{c}
        Points connected by a \textcolor{blue}{\textbf{Must link}} must stay close together\\
        Points connected by a \textcolor{red}{\textbf{Cannot link}} must stay far apart\\
        \includegraphics[height=15em]{poster_NADI_2018/images/app_guis_no_annotations.pdf}
    \end{tabular}
    \end{center}
\end{multicols}
